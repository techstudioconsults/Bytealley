...
>(
  (
    { side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...properties },
    reference,
  ) => {
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...properties }, reference) => {
    return (
      <div ref={reference} data-sidebar="header" className={cn("flex flex-col gap-2 p-2", className)} {...properties} />
    );
  },
);
...
const SidebarFooter = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...properties }, reference) => {
    return (
      <div ref={reference} data-sidebar="footer" className={cn("flex flex-col gap-2 p-2", className)} {...properties} />
    );
  },
);
...
const SidebarGroupContent = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...properties }, reference) => (
    <div ref={reference} data-sidebar="group-content" className={cn("w-full text-sm", className)} {...properties} />
  ),
);
