...
const Carousel = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & CarouselProperties>(
  ({ orientation = "horizontal", opts, setApi, plugins, className, children, ...properties }, reference) => {
